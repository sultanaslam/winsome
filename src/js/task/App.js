					...
					<div className="box">
						<div className="row firstRow">
							<div className="col-md-6">
								<a href="#modal1"><div className="imgHover img1"></div></a>
								
							</div>
							<div className="col-md-3 firstImage">
								<a href="#modal2"><div className="imgHover img2"></div></a>
							</div>
							<div className="col-md-3 secondImage">
								<a href="#modal3"><div className="imgHover img3"></div></a>
							</div>
						</div>
						<div className="row secondRow">
							<div className="col-md-3 thirdImage">
								<a href="#modal4"><div className="imgHover img4"></div></a>
							</div>
							<div className="col-md-3 forthImage">
								<a href="#modal5"><div className="imgHover img5"></div></a>
							</div>
							<div className="col-md-6">
								<a href="#modal6"><div className="imgHover img6"></div></a>
							</div>				
						</div>
					</div>
				</div>
